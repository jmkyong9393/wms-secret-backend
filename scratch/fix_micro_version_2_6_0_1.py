"""
====================================================================
[마이크로 버전 2.6.0.1 정밀 변경 스크립트]
- v2.7.0.0 및 v2.6.1.0 표기를 ver 2.6.0.1 로 100% 통일 변경
...
for doc_name in doc_files:
    ...
    if p.exists():
        ...
        # v2.7.0.0, v2.6.1.0 표기를 ver 2.6.0.1로 통일 변경
        new_content = (content.replace('[v2.7.0.0]', '[v2.6.0.1]')
                              .replace('ver 2.7.0.0', 'ver 2.6.0.1')
                              .replace('[v2.6.1.0]', '[v2.6.0.1]')
                              .replace('ver 2.6.1.0', 'ver 2.6.0.1'))
        
        with open(p, 'w', encoding='utf-8') as f:
            f.write(new_content)
        print(f"[Fixed Micro Version] {doc_name} -> v2.6.0.1")
...
print("[SUCCESS] All document version tags updated to ver 2.6.0.1 and synced to WMS_docs!")
